...
@section('isicontent')
    ...
    <section class="tm-section">
        <div class="container-fluid">
            ...
            <div class="row">
                <h3 style="text-align: center" class="tm-gold-text tm-title tm-margin-b-30">Latest Posts</h3>
            </div>
            <div class="row" style="text-align: center">
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 col-xl-3">
                    ...
                    <div class="tm-content-box">
                        <img src="{{ asset("assets/img/$datablogsatuan->image") }}" alt="Image" class="tm-margin-b-20 img-fluid">
                ...
                @endforeach
                <a style="margin-top: 3.5rem" href="{{ url("about") }}" class="tm-btn text-uppercase">More Blog</a>
            ...
            <div class="row tm-margin-t-big">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                    <div class="tm-2-col-left">
                        ...
                        <h3 class="tm-gold-text tm-title">Profile Perusahaan AFH IYH</h3>
                        <p class="tm-margin-b-30">Vivamus accumsan blandit ligula. Sed lobortis efficitur sapien</p>
                        <img src="{{ asset('assets/img/tm-img-660x330-1.jpg') }}" alt="Image Perusahaan" class="tm-margin-b-40 img-fluid">
                        <p>
                        ...
                        <a href="{{ url("about") }}" class="tm-btn text-uppercase">Read More</a>
